...
function Help() {
  return (
    <div className="text-secondary">
      <h2 className="h5 text-primary font-weight-normal">Cómo usar el proyecto</h2>
      <h3 className="h6 text-primary font-weight-normal">Cada repo tiene dos botones:</h3>
      <ul>
        <li>
          <p>
      ...
      <h3 className="h6 text-primary font-weight-normal">Función deshacer (Ctrl+Z):</h3>
      <p>
      ...
      <h3 className="h6 text-primary font-weight-normal">Colores de los repos:</h3>
      <p>
